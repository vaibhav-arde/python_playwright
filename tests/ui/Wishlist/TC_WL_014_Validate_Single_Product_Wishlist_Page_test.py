...
def test_validate_single_product_wishlist_page(authenticated_page):
    ...
    expect(authenticated_page).to_have_url(
        re.compile(rf".*{re.escape(UIRoutes.PRODUCT_DISPLAY)}.*")
    )
