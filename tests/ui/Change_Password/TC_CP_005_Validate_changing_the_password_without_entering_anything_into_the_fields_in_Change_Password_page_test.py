...
@pytest.mark.ui
def test_validate_change_password_without_entering_anything_into_the_fields_in_Change_Password_page(page):
    """
    ...
    change_password_page.fill_new_password_details("")
