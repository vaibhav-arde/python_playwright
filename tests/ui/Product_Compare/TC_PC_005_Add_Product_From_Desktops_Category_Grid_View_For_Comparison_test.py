...
@pytest.mark.ui
def test_add_product_from_desktops_category_grid_view_for_comparison(page):
    """Verify that a product can be added to comparison from the Desktops category grid view."""
