...
def test_add_product_from_search_results_grid_view_for_comparison(page, product_names):
    """Verify that a product can be added to comparison from search results grid view."""
