...
<<<<<<< HEAD:tests/ui/Product_Display_Page/TC_PDP_030_Validate_navigating_to_PDP_using_Product_Name_link_in_Cart_button_toggle_box_test.py
    
=======
    registration_page = RegistrationPage(page)

<<<<<<< HEAD:tests/ui/Product_Display_Page/TC_PDP_030_Validate_navigating_to_PDP_using_Product_Name_link_in_Cart_button_toggle_box_test.py
>>>>>>> 6193c1f (updated Insted of login regester is used):tests/ui/ProductDisplayPage/TC_PDP_030_Validate_navigating_to_PDP_using_Product_Name_link_in_Cart_button_toggle_box_test.py
    product_name = TestData.PRODUCT_NAME_IMAC
=======
>>>>>>> 93d3e1a (TC -031 ia added and some changes are done):tests/ui/ProductDisplayPage/TC_PDP_030_Validate_navigating_to_PDP_using_Product_Name_link_in_Cart_button_toggle_box_test.py
