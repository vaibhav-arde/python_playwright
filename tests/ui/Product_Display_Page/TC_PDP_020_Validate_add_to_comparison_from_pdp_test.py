...
<<<<<<< HEAD:tests/ui/Product_Display_Page/TC_PDP_020_Validate_add_to_comparison_from_pdp_test.py
...
>>>>>>> 93d3e1a (TC -031 ia added and some changes are done):tests/ui/ProductDisplayPage/TC_PDP_020_Validate_add_to_comparison_from_pdp_test.py
