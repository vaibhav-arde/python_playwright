...
<<<<<<< HEAD:tests/ui/Product_Display_Page/TC_PDP_023_Navigate_to_PDP_via_wishlist_image_test.py
=======
from utils.random_test_data import RandomTestData
>>>>>>> 6193c1f (updated Insted of login regester is used):tests/ui/ProductDisplayPage/TC_PDP_023_Navigate_to_PDP_via_wishlist_image_test.py
