...
<<<<<<< HEAD:tests/ui/Product_Display_Page/TC_PDP_027_Validate_navigating_to_PDP_using_Product_Name_link_in_Shopping_Cart_page_test.py
...
<<<<<<< HEAD:tests/ui/Product_Display_Page/TC_PDP_027_Validate_navigating_to_PDP_using_Product_Name_link_in_Shopping_Cart_page_test.py
>>>>>>> 6193c1f (updated Insted of login regester is used):tests/ui/ProductDisplayPage/TC_PDP_027_Validate_navigating_to_PDP_using_Product_Name_link_in_Shopping_Cart_page_test.py
    product_name = TestData.PRODUCT_NAME_IMAC
=======
>>>>>>> 93d3e1a (TC -031 ia added and some changes are done):tests/ui/ProductDisplayPage/TC_PDP_027_Validate_navigating_to_PDP_using_Product_Name_link_in_Shopping_Cart_page_test.py
