...
def test_validate_navigating_to_pdp_using_product_image_in_shopping_cart_page(page: Page):
    """
    Test Case ID: TC_PDP_026
    Validate navigating to the Product Display page by using the Product image in the 'Shopping Cart' page
    """
    home_page = HomePage(page)
    search_results_page = SearchResultsPage(page)
    product_page = ProductPage(page)
<<<<<<< HEAD:tests/ui/Product_Display_Page/TC_PDP_026_Validate_navigating_to_PDP_using_Product_Image_in_Shopping_Cart_page_test.py
...
<<<<<<< HEAD:tests/ui/Product_Display_Page/TC_PDP_026_Validate_navigating_to_PDP_using_Product_Image_in_Shopping_Cart_page_test.py
>>>>>>> 6193c1f (updated Insted of login regester is used):tests/ui/ProductDisplayPage/TC_PDP_026_Validate_navigating_to_PDP_using_Product_Image_in_Shopping_Cart_page_test.py
    product_name = TestData.PRODUCT_NAME_IMAC
=======
>>>>>>> 93d3e1a (TC -031 ia added and some changes are done):tests/ui/ProductDisplayPage/TC_PDP_026_Validate_navigating_to_PDP_using_Product_Image_in_Shopping_Cart_page_test.py
...
>>>>>>> 6193c1f (updated Insted of login regester is used):tests/ui/ProductDisplayPage/TC_PDP_026_Validate_navigating_to_PDP_using_Product_Image_in_Shopping_Cart_page_test.py
    ...
    # Step 4: Click image link in shopping cart table
    shopping_cart_page.click_product_image(expected_name)
