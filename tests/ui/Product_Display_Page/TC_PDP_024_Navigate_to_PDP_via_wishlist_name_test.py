...
def test_navigate_to_pdp_via_wishlist_name(authenticated_page: Page):
    """
    ...
    # Step 4: Click on the Product name link in the 'Wish List' page
    wishlist_page.click_product_name(expected_name)
