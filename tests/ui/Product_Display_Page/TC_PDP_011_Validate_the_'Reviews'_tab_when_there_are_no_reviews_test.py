...
=======
    assert (
        ...
        expected=messages.PDP_NO_REVIEWS_TEXT, actual=actual_no_reviews_text
>>>>>>> 387ee9d (style: apply ruff formatting to resolved test files):tests/ui/ProductDisplayPage/TC_PDP_011_Validate_the_'Reviews'_tab_when_there_are_no_reviews_test.py
    )
========
    assert (
        actual_no_reviews_text == messages.PDP_NO_REVIEWS_TEXT
