...
def test_validate_navigating_to_pdp_using_product_image_in_shopping_cart_page(page: Page):
    ...
    # Step 1-2: Enter Product Name and Click Search icon
    ...
    # Step 6 (ER-1): Click on the Product image from the displayed Shopping Cart page
    new_product_page = shopping_cart_page.click_product_image()
