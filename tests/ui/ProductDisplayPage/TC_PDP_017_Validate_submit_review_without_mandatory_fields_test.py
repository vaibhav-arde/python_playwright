...
def test_validate_submit_review_without_mandatory_fields(page: Page):
    ...
    Steps:
        ...
        6. Don't provide Name, Your Review and Ratings and click on 'Continue' button.

    Expected Result:
        Proper warning messages informing the User to fill the mandatory fields to submit the review should be displayed.
    """
    ...
    # Step 6: Submit review without filling Name, Your Review, and Ratings
    product_page.submit_review()

    # Validate ER-1: Proper warning messages informing the User to fill mandatory fields should be displayed
