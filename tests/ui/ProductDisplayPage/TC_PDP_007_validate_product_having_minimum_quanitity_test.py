...
>>>>>>> 387ee9d (style: apply ruff formatting to resolved test files)
...
>>>>>>>> a50202b (style: fix formatting issues):tests/ui/ProductDisplayPage/TC_PDP_007_validate_product_having_minimum_quanitity_test.py
