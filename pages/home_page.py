...
=======
import re
>>>>>>> feature/Add_to_Cart_functionality
...
<<<<<<< HEAD
        ...
        self.lnk_register = page.locator('#top-links a:has-text("Register")').first
        self.lnk_login = page.locator('#top-links a:has-text("Login")').first
