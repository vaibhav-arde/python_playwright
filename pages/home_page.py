...
class HomePage(BasePage):
    ...
    def __init__(self, page: Page):
        ...
        self.lnk_login = page.locator("ul.dropdown-menu").get_by_role(
            "link", name="Login"
        )
        ...
        self.list_slider_pagination = page.locator(".swiper-pagination-bullet")
        self.img_active_hero = self.cnt_hero_slider.locator(
            ".swiper-slide-active img, .swiper-slide-duplicate-active img"
        ).first

        # Featured Products
        self.txt_featured_heading = page.locator('h3:has-text("Featured")')
        ...
        self.active_partner = self.partner_carousel.locator(".swiper-slide-active")
        ...
        self.partner_pagination = page.locator(".swiper-pagination-bullet")
    ...
    def get_slider_images_count(self) -> int:
        self.list_slider_images.first.wait_for(state="visible")
    ...
    def verify_image_changed(self, previous_src: str):
        for _ in range(10):
            ...
            if new_src != previous_src:
                return
        raise AssertionError("Hero slider image did not change")
    ...
    def verify_partner_next_button_working(self):
        ...
        for _ in range(10):
            ...
            if self.get_active_partner_index() != before:
                return

        raise AssertionError("Partner next button did not move slider")
    ...
    def verify_partner_slider_working(self):
        ...
        raise AssertionError("Partner slider did not auto move")

    # Breadcrumb

    def click_breadcrumb_home(self):
        self.icon_breadcrumb_home.wait_for(state="visible")
